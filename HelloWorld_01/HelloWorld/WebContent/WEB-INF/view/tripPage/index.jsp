		...
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-10 mx-auto">
					...
					<a class="btn btn-dark btn-xl js-scroll-trigger" href="#services">What
						We Offer</a>
				</div>
			</div>
		</div>
			...
			<div class="row no-gutters">
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="../images/img/portfolio-1.jpg" alt="">
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="../images/img/portfolio-2.jpg" alt="">
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="../images/img/portfolio-3.jpg" alt="">
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="../images/img/portfolio-4.jpg" alt="">
					</a>
				</div>
			</div>
		</div>
